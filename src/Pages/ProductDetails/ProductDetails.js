          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="md:py-8">
              <div className="mb-2 md:mb-3">
                <span className="inline-block text-gray-500 mb-0.5 capitalize">
                  {category}
                </span>
              ...
              <div className="sm:order-1 mb-5 w-10">
              ...
              <div className="mt-10 md:mt-16 lg:mt-20">
                ...
                {description.split(",").map((features) => (
                  <p key={Math.random()} className="text-gray-500">
                    {features}
                  </p>
                ))}
              </div>
